...
public class ChatFragment extends ListFragment {
    ...
    private static Chat mActivity = null;

    private ArrayList<MessageDetails> mMessageList = null;   // a list of chat msgs.
    private ArrayAdapter<MessageDetails> mAdapter= null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.fragment_chat, container, false);  // no care whatever container is.
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MessageDetails row = new MessageDetails(mApp.mDeviceName, inputMsg, null);
                appendChatMessage(row);
                String jsonMsg = mApp.shiftInsertMessage(row);
                Log.d(TAG, "sendButton clicked: sendOut data : " + jsonMsg);
        ...
        if( savedInstanceState != null ){
            ...
            mMessageList = new ArrayList<MessageDetails>();
        ...
        Log.d(TAG, "onCreate chat msg fragment: devicename : " + mApp.mDeviceName + " : " + getArguments().getString("initMsg"));
        return contentView;
    }
     ...
     */
    public void appendChatMessage(MessageDetails row) {
    ...
    private void jsonArrayToList(JSONArray jsonarray, List<MessageDetails> list) {
        try{
            for(int i=0;i<jsonarray.length();i++){
                MessageDetails row = MessageDetails.parseMesssageRow(jsonarray.getJSONObject(i));
                Log.d(TAG, "jsonArrayToList: row : " + row.mMsg);
                list.add(row);
            }
        }catch(JSONException e){
            Log.e(TAG, "jsonArrayToList: " + e.toString());
        }
    }
     ...
     */
    final class ChatMessageAdapter extends ArrayAdapter<MessageDetails> {
        ...
        public ChatMessageAdapter(Context context, List<MessageDetails> objects){
        ...
        public int getItemViewType(int position) {
            MessageDetails item = this.getItem(position);
