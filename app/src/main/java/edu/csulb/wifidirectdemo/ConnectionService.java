...
import static edu.csulb.wifidirectdemo.Constants.MSG_BROKEN_CONN;
import static edu.csulb.wifidirectdemo.Constants.MSG_FINISH_CONNECT;
import static edu.csulb.wifidirectdemo.Constants.MSG_NEW_CLIENT;
import static edu.csulb.wifidirectdemo.Constants.MSG_NULL;
import static edu.csulb.wifidirectdemo.Constants.MSG_PULLIN_DATA;
import static edu.csulb.wifidirectdemo.Constants.MSG_PUSHOUT_DATA;
import static edu.csulb.wifidirectdemo.Constants.MSG_REGISTER_ACTIVITY;
import static edu.csulb.wifidirectdemo.Constants.MSG_SELECT_ERROR;
...
public class ConnectionService extends Service implements ChannelListener, PeerListListener, ConnectionInfoListener{
    ...
    WifiDirectApp mApp;
    Chat mActivity;    // shall I use weak reference here ?
    ...
    private void processIntent(Intent intent){
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {  // this devices's wifi direct enabled state.
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                ...
                mApp.mP2pChannel = mApp.mP2pMan.initialize(this, mWorkHandler.getLooper(), null);
                SysPreferences.setStringToPref(mApp, SysPreferences.PREF_NAME, SysPreferences.P2P_ENABLED, "1");
                ...
                SysPreferences.setStringToPref(mApp, SysPreferences.PREF_NAME, SysPreferences.P2P_ENABLED, "0");
            }
    ...
    private void processMessage(android.os.Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_REGISTER_ACTIVITY:
                ...
                onActivityRegister((Chat)msg.obj, msg.arg1);
                break;
     ...
     */
    private void onActivityRegister(Chat activity, int register){
    ...
    private String onPullInData(SocketChannel schannel, Bundle b){
        ...
        MessageDetails row = MessageDetails.parseMessageRow(data);
     ...
     */
    public void showNotification(MessageDetails row) {
        ...
        Intent notificationIntent = mApp.getLauchActivityIntent(Chat.class, row.mMsg);
        ...
        notification = notiBuilder.setSmallIcon(R.drawable.ic_action_discover).setContentTitle(title).setContentText(text).setContentIntent(contentIntent).build();
     ...
     */
    private void showInActivity(final MessageDetails row){
